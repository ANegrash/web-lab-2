    ...
    <form method="post" onsubmit="checkText(this);" action="/Lab2/control">
        <table id="page-table-F">
            ...
            <tr>
                ...
                <td class="chooseable" colspan="7"><input class="form-control" id="text_input_Y" type="text" name="answerY" value="0">
                </td>
            </tr>

            <tr>
                <td colspan="7">Change R [2;5]</td>
                <td class="chooseable" colspan="7"><input class="form-control" id="text_input_R" type="text" name="answerR" value="2">
                </td>
            </tr>
